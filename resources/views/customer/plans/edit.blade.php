    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("customers.plans.update", [$plan->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="price" id="price" value="{{ old('price', $plan->price) }}" step="1" required>
                            @if($errors->has('price'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('price') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="stripe_identifier" id="stripe_identifier" value="{{ old('stripe_identifier', $plan->stripe_identifier) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="billing_period" id="billing_period" value="{{ old('billing_period', $plan->billing_period) }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                <input type="checkbox" name="status" id="status" value="1" {{ $plan->status || old('status', 0) === 1 ? 'checked' : '' }} required>
