    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("customers.payments.update", [$payment->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="stripe" id="stripe" value="{{ old('stripe', $payment->stripe) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="subtotal" id="subtotal" value="{{ old('subtotal', $payment->subtotal) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="tax" id="tax" value="{{ old('tax', $payment->tax) }}" step="1" required>
                            @if($errors->has('tax'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('tax') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total" id="total" value="{{ old('total', $payment->total) }}" step="1" required>
                            @if($errors->has('total'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('total') }}
                                </div>
