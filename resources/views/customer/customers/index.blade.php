        ...
        <div class="col-md-12">
            @can('customer_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('customer.customers.create') }}">
                                ...
                                @foreach($customers as $key => $customer)
                                    <tr data-entry-id="{{ $customer->id }}">
                                        ...
                                        <td>
                                            ...
                                            @can('customer_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('customer.customers.edit', $customer->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('customer_delete')
                                                <form action="{{ route('customer.customers.destroy', $customer->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
